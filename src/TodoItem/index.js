...
function TodoItem(props){
    ...
    return (
        <li className="TodoItem">
            <svg className={`check Icon-check ${props.completed && 'Icon-check--active'}`} 
                onClick={props.onComplete} role="img" focusable="false" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14"><path fill="green"
